...
class ExtractionAddisonFM(ExtractionWavelet):
    ...
    def extract(self, ecg_signal: pd.DataFrame, sampling_rate: float):
        ...
        # take the maximum frequencies using the found indices (#TODO Could maybe be optimised in one step)
...
class ExtractionGarde(BaseExtraction):
    ...
    Maybe too much noise but more likely #TODO an implementation error in __ccf()
